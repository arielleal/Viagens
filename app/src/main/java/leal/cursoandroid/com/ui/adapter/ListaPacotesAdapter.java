package leal.cursoandroid.com.ui.adapter;
...
public class ListaPacotesAdapter extends BaseAdapter {
    ...
    private void mostraImagem(View viewCriada, Pacote pacote) {
        ImageView imagem = viewCriada.findViewById(R.id.item_pacote_image);
        Drawable drawableImagePacote = ResouceUtil.devolveDrawable(context, pacote.getImagem());
